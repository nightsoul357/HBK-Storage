...
{
    public class ClearCombineHandler : CombineHandlerBase
    {
        private CombineHandlerTaskModel _currentTaskModel;
        public ClearCombineHandler(ILogger<ClearCombineHandler> logger, CombineHandlerBase internalCombineHandler = null)
