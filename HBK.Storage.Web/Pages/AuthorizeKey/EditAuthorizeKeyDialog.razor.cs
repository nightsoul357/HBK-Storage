...
{
    public partial class EditAuthorizeKeyDialog
    {
        [CascadingParameter]
        ...
        public async Task SaveChangeAsync()
        {
            if (!this.IsEditMode)
            {
                ...
                if (this.IsRead)
                {
                    ...
                    {
                        Storage_provider_id = this.StateContainer.StorageProvider.Storage_provider_id,
        ...
        {
            if (this.EditAuthorizeKey.Authorize_key_id == this.StateContainer.AuthorizeKey.Authorize_key_id)
            {
